...
import { Shield, Check, X, AlertTriangle, Eye, ShieldAlert, PackageX } from 'lucide-react'
              ...
              <div className="relative aspect-square w-full cursor-pointer overflow-hidden" onClick={() => setSelectedImage(item.image_url)}>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent p-4 flex flex-col justify-between">
                  <div className="flex justify-end">
                    <Badge className="bg-orange-500 text-white border-none uppercase text-[9px] font-black tracking-widest shadow-[0_0_15px_rgba(249,115,22,0.5)]">
                      AI Flagged
                    </Badge>
                  </div>
              ...
              <div className="p-5 space-y-4 flex-1 flex flex-col justify-between border-t border-sidebar-border bg-sidebar-accent/10">
                ...
                <div className="grid grid-cols-2 gap-3 pt-4 border-t border-sidebar-border">
                  <Button 
                    ...
                    className="h-12 rounded-xl border-destructive/20 text-destructive hover:bg-destructive/10 hover:text-destructive uppercase font-black text-[10px] tracking-widest flex items-center justify-center gap-2"
                  >
                  ...
                  <Button 
                    ...
                    disabled={processing === item.product_id}
                    className="h-12 rounded-xl bg-green-600 hover:bg-green-500 text-white uppercase font-black text-[10px] tracking-widest shadow-[0_5px_15px_rgba(22,163,74,0.3)] flex items-center justify-center gap-2"
                  >
                    {processing === item.product_id ? (
                      <div className="h-4 w-4 border-2 border-current border-t-transparent animate-spin rounded-full" />
                    ) : (
